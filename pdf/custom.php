...
try {
    ...
    if (empty($ultimosServicos)) {

   

      // Definir variáveis de sessão
      $_SESSION['nome_mes'] = $nome_mes;
      $_SESSION['anoAtual'] = $anoAtual;

      echo "<script>window.location='../error.php';</script>";
     
        exit; // Encerra o script se nenhum registro for encontrado
    }
...
<header>
  <div >
    ...
    <div>
      ...
      <p>
         <b>Relatorio gerado em: </b> ' . $mesAtualD . '/' . $anoAtualD . '
      </p>
    </div>
    <br>
    <h3> <center> Relatório Gerado Referente a '. $nome_mes  .' de '.$anoAtual.'  </center> </h3>
  </div>
