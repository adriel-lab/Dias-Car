            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 mx-auto text-center">
                        <h1 class="fs-2 mb-2"> CADASTRAR CLIENTE</h1>
                        <p class="mb-0">Cadastre os clientes aqui.</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 mx-auto">
                        ...
                        <form method="POST" action="upCliente.php" class="vstack gap-4">

                            <!-- Owner Detail START -->
                            <div class="card shadow">
                                <!-- Card header -->
                                <div class="card-header border-bottom">
                                    <h5 class="mb-0">Cadastrar clientes</h5>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        <form method="POST" action="upCliente.php" class="row g-3">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <var style="font-size: 12px; color: red"> *Não obrigatório</var>
                                            ...
                                            <div class="col-md-4">
                                                <label for="numero_residencial" class="form-label">Número Residencial:</label>
                                                <input type="text" class="form-control" id="numero_residencial" name="numero_residencial" required>
                                            </div>
                                            <div class="col-md-2">
                            ...
                            <div class="text-end">
                                ...
                                <a href="cadastrar_carro.php" class="btn btn-primary-soft mb-0"><i class="bi bi-arrow-right"></i> Cadastrar Carro</a><br>
                            </div>
